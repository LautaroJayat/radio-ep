...
/// POST REQUESTS
router.post('/upload/user/photo', isAdmin,u_ctrl.update_photo);
...
/// PUT REQUESTS
router.put('/users/info/modify/',isAdmin, u_ctrl.modify_info);

router.put('/users/pass/modify', isAdmin,u_ctrl.modify_password);

router.put('/users/social/modify/', isAdmin,u_ctrl.modify_social);
